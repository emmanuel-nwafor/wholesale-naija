...
export default function BuyersActionsModal({ show, onClose, isMobileOrTablet, onDeleteClick }: ActionsModalProps) {
          ...
          <motion.div
            ...
            className={`fixed z-50 ${
              isMobileOrTablet
                ...
                : 'right-4 w-64 rounded-2xl shadow-2xl border border-gray-200'
