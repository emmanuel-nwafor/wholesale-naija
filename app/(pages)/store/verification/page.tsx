...
export default function RequestVerificationPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.nin || !formData.cacNumber || !formData.businessName || !formData.businessRegNumber) {
              ...
              <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
                ...
                <div className="flex-1 bg-white rounded-3xl p-6 md:p-8">
                  ...
                  <p className="text-sm text-gray-600 mb-8 max-w-2xl">
                    Get verified to build trust with buyers. Submit your business details for review. 
                    Once approved, you'll get a verified badge on your store.
                  </p>
