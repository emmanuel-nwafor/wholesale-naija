...
export default function ProductDetailsPage() {
  ...
  const displayMOQ = variant?.MOQ || 20;
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 p-6 lg:p-8 md:ml-64">
          <div className="max-w-7xl mx-auto">
            ...
            {/* Main Card - Your Original Clean Design */}
              ...
              <div className="p-6 lg:p-10">
                ...
                <div className="grid lg:grid-cols-2 gap-12">
                  ...
                  <div className="space-y-6">
                    <div className="relative aspect-[3/3] rounded-3xl overflow-hidden bg-gray-50">
                      <Image
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="space-y-6">
                      <div className="bg-gray-100 rounded-2xl p-6">
                        ...
                        <p className="text-gray-600 text-base mt-2">
                          MOQ: {displayMOQ} pieces
                        </p>
                      </div>

                      {/* Tiered Pricing - Apple Style */}
                    ...
                    <div className="flex gap-4 pt-6">
                      <button className="flex items-center gap-2 px-14 py-4 border border-red-300 text-red-600 rounded-xl hover:bg-red-50 transition text-sm font-medium">
                        <Trash2 className="w-4 h-4" />
                        Delete Product
                      </button>
                      <button className="flex items-center gap-2 px-14 py-4 bg-[#1e293b] text-white rounded-xl hover:bg-[#0f172a] transition text-sm font-medium">
